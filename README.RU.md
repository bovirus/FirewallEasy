...
Поддерживаются следующие языки: английский, русский, китайский (упрощённый), китайский (традиционный), испанский, португальский (бразильский португальский), французский, немецкий, японский, арабский, итальянский, корейский, турецкий и польский. 
...
## Особенности
**• Блокировка доступа в интернет в пару кликов**<br>
![](https://github.com/user-attachments/assets/eea59e53-cb67-422a-ad93-81764dd4cbfe)<br>
...
| Описание | Сокращённая команда | Полная команда |
|----------|---------------------|----------------|
| Блокировка доступа приложению в интернет | `-b "App.exe"` | `--block "App.exe"` |
| Разблокировать доступ приложению | `-u "App.exe"` | `--unblock "App.exe"` |
| Импортировать правила из файла | `-i "Rules.fer"` | `--import "Rules.fer"` |
| Экспортировать текущие правила в файл | `-e "Rules.fer"` | `--export "Rules.fer"` |
| Тихий режим (закрытие после выполнения) | `-s` | `--silent` |

Используйте командную строку или скрипты для блокировки и разблокировки интернет-доступа приложений.
